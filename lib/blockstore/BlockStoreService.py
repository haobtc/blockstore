      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i109 in xrange(_size105):
            ...
            self.addresses.append(_elem110)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i123 in xrange(_size119):
            ...
            self.addresses.append(_elem124)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 3:
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i158 in xrange(_size154):
            ...
            self.addresses.append(_elem159)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i172 in xrange(_size168):
            ...
            self.addresses.append(_elem173)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 3:
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i214 in xrange(_size210):
            ...
            self.addresses.append(_elem215)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i242 in xrange(_size238):
            ...
            self.addresses.append(_elem243)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
