...
class Iface:
  ...
  def getRelatedAddrTxIdList(self, network, addresses, cursor, count):
    """
    Parameters:
     - network
     - addresses
  ...
  def getUnspentV1(self, network, addresses, count):
    """
    Parameters:
     - network
     - addresses
  ...
  def getAddressStatList(self, network, addresses):
    """
    Parameters:
     - network
     - addresses
  ...
  def watchAddresses(self, network, group, addresses):
    """
    Parameters:
     - network
     - group
  ...
  def getWatchingList(self, network, group, count, cursor):
    """
    Parameters:
     - network
     - group
  ...
  def getWatchingAddressList(self, network, group, count, cursor):
    """
    Parameters:
     - network
     - group
...
class Client(Iface):
  ...
  def getRelatedAddrTxIdList(self, network, addresses, cursor, count):
    ...
    Parameters:
     ...
     - count
    """
    self.send_getRelatedAddrTxIdList(network, addresses, cursor, count)
    return self.recv_getRelatedAddrTxIdList()

  def send_getRelatedAddrTxIdList(self, network, addresses, cursor, count):
    self._oprot.writeMessageBegin('getRelatedAddrTxIdList', TMessageType.CALL, self._seqid)
    args = getRelatedAddrTxIdList_args()
    args.network = network
    args.addresses = addresses
    args.cursor = cursor
    args.count = count
  ...
  def recv_getRelatedAddrTxIdList(self):
    iprot = self._iprot
    (fname, mtype, rseqid) = iprot.readMessageBegin()
    if mtype == TMessageType.EXCEPTION:
      x = TApplicationException()
      ...
      iprot.readMessageEnd()
      raise x
    result = getRelatedAddrTxIdList_result()
    result.read(iprot)
    iprot.readMessageEnd()
    if result.success is not None:
      return result.success
    raise TApplicationException(TApplicationException.MISSING_RESULT, "getRelatedAddrTxIdList failed: unknown result");
  ...
  def getUnspentV1(self, network, addresses, count):
    ...
    Parameters:
     ...
     - count
    """
    self.send_getUnspentV1(network, addresses, count)
    return self.recv_getUnspentV1()

  def send_getUnspentV1(self, network, addresses, count):
    self._oprot.writeMessageBegin('getUnspentV1', TMessageType.CALL, self._seqid)
    args = getUnspentV1_args()
    args.network = network
    args.addresses = addresses
    args.count = count
    args.write(self._oprot)
  ...
  def recv_getUnspentV1(self):
    ...
    if mtype == TMessageType.EXCEPTION:
      ...
      iprot.readMessageEnd()
      raise x
    result = getUnspentV1_result()
    result.read(iprot)
    iprot.readMessageEnd()
    if result.success is not None:
      return result.success
    raise TApplicationException(TApplicationException.MISSING_RESULT, "getUnspentV1 failed: unknown result");
  ...
  def getAddressStatList(self, network, addresses):
    ...
    Parameters:
     ...
     - addresses
    """
    self.send_getAddressStatList(network, addresses)
    return self.recv_getAddressStatList()

  def send_getAddressStatList(self, network, addresses):
    self._oprot.writeMessageBegin('getAddressStatList', TMessageType.CALL, self._seqid)
    args = getAddressStatList_args()
    args.network = network
    args.addresses = addresses
    args.write(self._oprot)
    self._oprot.writeMessageEnd()
  ...
  def recv_getAddressStatList(self):
    iprot = self._iprot
    (fname, mtype, rseqid) = iprot.readMessageBegin()
    if mtype == TMessageType.EXCEPTION:
      x = TApplicationException()
      ...
      iprot.readMessageEnd()
      raise x
    result = getAddressStatList_result()
    result.read(iprot)
    iprot.readMessageEnd()
    if result.success is not None:
      return result.success
    raise TApplicationException(TApplicationException.MISSING_RESULT, "getAddressStatList failed: unknown result");
  ...
  def watchAddresses(self, network, group, addresses):
    ...
    Parameters:
     ...
     - addresses
    """
    self.send_watchAddresses(network, group, addresses)
    self.recv_watchAddresses()

  def send_watchAddresses(self, network, group, addresses):
    self._oprot.writeMessageBegin('watchAddresses', TMessageType.CALL, self._seqid)
    args = watchAddresses_args()
    args.network = network
    args.group = group
    args.addresses = addresses
    args.write(self._oprot)
  ...
  def getWatchingList(self, network, group, count, cursor):
    ...
    Parameters:
     ...
     - cursor
    """
    self.send_getWatchingList(network, group, count, cursor)
    return self.recv_getWatchingList()

  def send_getWatchingList(self, network, group, count, cursor):
    self._oprot.writeMessageBegin('getWatchingList', TMessageType.CALL, self._seqid)
    args = getWatchingList_args()
    args.network = network
    args.group = group
    args.count = count
    args.cursor = cursor
  ...
  def recv_getWatchingList(self):
    ...
    if mtype == TMessageType.EXCEPTION:
      ...
      iprot.readMessageEnd()
      raise x
    result = getWatchingList_result()
    result.read(iprot)
    iprot.readMessageEnd()
    if result.success is not None:
      return result.success
    raise TApplicationException(TApplicationException.MISSING_RESULT, "getWatchingList failed: unknown result");
  ...
  def getWatchingAddressList(self, network, group, count, cursor):
    ...
    Parameters:
     ...
     - cursor
    """
    self.send_getWatchingAddressList(network, group, count, cursor)
    return self.recv_getWatchingAddressList()

  def send_getWatchingAddressList(self, network, group, count, cursor):
    self._oprot.writeMessageBegin('getWatchingAddressList', TMessageType.CALL, self._seqid)
    args = getWatchingAddressList_args()
    args.network = network
    args.group = group
    args.count = count
    args.cursor = cursor
  ...
  def recv_getWatchingAddressList(self):
    iprot = self._iprot
    (fname, mtype, rseqid) = iprot.readMessageBegin()
    if mtype == TMessageType.EXCEPTION:
      x = TApplicationException()
      ...
      iprot.readMessageEnd()
      raise x
    result = getWatchingAddressList_result()
    result.read(iprot)
    iprot.readMessageEnd()
    if result.success is not None:
      return result.success
    raise TApplicationException(TApplicationException.MISSING_RESULT, "getWatchingAddressList failed: unknown result");
...
class Processor(Iface, TProcessor):
  def __init__(self, handler):
    ...
    self._processMap["getRelatedAddrTxIdList"] = Processor.process_getRelatedAddrTxIdList
    ...
    self._processMap["getUnspentV1"] = Processor.process_getUnspentV1
    ...
    self._processMap["getAddressStatList"] = Processor.process_getAddressStatList
    self._processMap["pushPeers"] = Processor.process_pushPeers
    self._processMap["popPeers"] = Processor.process_popPeers
    self._processMap["watchAddresses"] = Processor.process_watchAddresses
    self._processMap["getWatchingList"] = Processor.process_getWatchingList
    self._processMap["getWatchingAddressList"] = Processor.process_getWatchingAddressList
  ...
  def process_getRelatedAddrTxIdList(self, seqid, iprot, oprot):
    args = getRelatedAddrTxIdList_args()
    args.read(iprot)
    iprot.readMessageEnd()
    result = getRelatedAddrTxIdList_result()
    result.success = self._handler.getRelatedAddrTxIdList(args.network, args.addresses, args.cursor, args.count)
    oprot.writeMessageBegin("getRelatedAddrTxIdList", TMessageType.REPLY, seqid)
    result.write(oprot)
    oprot.writeMessageEnd()
    oprot.trans.flush()
  ...
  def process_getUnspentV1(self, seqid, iprot, oprot):
    args = getUnspentV1_args()
    args.read(iprot)
    iprot.readMessageEnd()
    result = getUnspentV1_result()
    result.success = self._handler.getUnspentV1(args.network, args.addresses, args.count)
    oprot.writeMessageBegin("getUnspentV1", TMessageType.REPLY, seqid)
    result.write(oprot)
    oprot.writeMessageEnd()
    oprot.trans.flush()
  ...
  def process_getAddressStatList(self, seqid, iprot, oprot):
    args = getAddressStatList_args()
    args.read(iprot)
    iprot.readMessageEnd()
    result = getAddressStatList_result()
    result.success = self._handler.getAddressStatList(args.network, args.addresses)
    oprot.writeMessageBegin("getAddressStatList", TMessageType.REPLY, seqid)
    result.write(oprot)
    oprot.writeMessageEnd()
    oprot.trans.flush()
  ...
  def process_watchAddresses(self, seqid, iprot, oprot):
    args = watchAddresses_args()
    args.read(iprot)
    iprot.readMessageEnd()
    result = watchAddresses_result()
    self._handler.watchAddresses(args.network, args.group, args.addresses)
    oprot.writeMessageBegin("watchAddresses", TMessageType.REPLY, seqid)
    result.write(oprot)
    oprot.writeMessageEnd()
    oprot.trans.flush()

  def process_getWatchingList(self, seqid, iprot, oprot):
    args = getWatchingList_args()
    args.read(iprot)
    iprot.readMessageEnd()
    result = getWatchingList_result()
    result.success = self._handler.getWatchingList(args.network, args.group, args.count, args.cursor)
    oprot.writeMessageBegin("getWatchingList", TMessageType.REPLY, seqid)
    result.write(oprot)
    oprot.writeMessageEnd()
    oprot.trans.flush()

  def process_getWatchingAddressList(self, seqid, iprot, oprot):
    args = getWatchingAddressList_args()
    args.read(iprot)
    iprot.readMessageEnd()
    result = getWatchingAddressList_result()
    result.success = self._handler.getWatchingAddressList(args.network, args.group, args.count, args.cursor)
    oprot.writeMessageBegin("getWatchingAddressList", TMessageType.REPLY, seqid)
    result.write(oprot)
    oprot.writeMessageEnd()
    oprot.trans.flush()
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i116 in xrange(_size112):
            ...
            self.addresses.append(_elem117)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
...
class getRelatedAddrTxIdList_args:
  """
  Attributes:
   - network
   - addresses
  ...
  thrift_spec = (
    ...
    (1, TType.I32, 'network', None, None, ), # 1
    (2, TType.LIST, 'addresses', (TType.STRING,None), None, ), # 2
    (3, TType.STRING, 'cursor', None, None, ), # 3
    (4, TType.I32, 'count', None, None, ), # 4
  )

  def __init__(self, network=None, addresses=None, cursor=None, count=None,):
    self.network = network
    self.addresses = addresses
    self.cursor = cursor
    self.count = count
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('getRelatedAddrTxIdList_args')
    if self.network is not None:
      oprot.writeFieldBegin('network', TType.I32, 1)
      oprot.writeI32(self.network)
      oprot.writeFieldEnd()
...
class getRelatedAddrTxIdList_result:
  """
  Attributes:
   - success
  """
  ...
  thrift_spec = (
    (0, TType.LIST, 'success', (TType.STRUCT,(AddrTxId, AddrTxId.thrift_spec)), None, ), # 0
  )
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('getRelatedAddrTxIdList_result')
    if self.success is not None:
      oprot.writeFieldBegin('success', TType.LIST, 0)
      oprot.writeListBegin(TType.STRUCT, len(self.success))
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i165 in xrange(_size161):
            ...
            self.addresses.append(_elem166)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
...
class getUnspentV1_args:
  ...
  def __init__(self, network=None, addresses=None, count=None,):
    self.network = network
    self.addresses = addresses
    self.count = count
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i179 in xrange(_size175):
            ...
            self.addresses.append(_elem180)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 3:
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('getUnspentV1_args')
    if self.network is not None:
      oprot.writeFieldBegin('network', TType.I32, 1)
      oprot.writeI32(self.network)
      oprot.writeFieldEnd()
...
class getUnspentV1_result:
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('getUnspentV1_result')
    if self.success is not None:
      oprot.writeFieldBegin('success', TType.LIST, 0)
      oprot.writeListBegin(TType.STRUCT, len(self.success))
...
class getAddressStatList_args:
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i221 in xrange(_size217):
            ...
            self.addresses.append(_elem222)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('getAddressStatList_args')
    if self.network is not None:
      oprot.writeFieldBegin('network', TType.I32, 1)
      oprot.writeI32(self.network)
      oprot.writeFieldEnd()
...
class getAddressStatList_result:
  """
  Attributes:
   - success
  """
  ...
  thrift_spec = (
    (0, TType.LIST, 'success', (TType.STRUCT,(AddrStat, AddrStat.thrift_spec)), None, ), # 0
  )
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('getAddressStatList_result')
    if self.success is not None:
      oprot.writeFieldBegin('success', TType.LIST, 0)
      oprot.writeListBegin(TType.STRUCT, len(self.success))
...
class watchAddresses_args:
  ...
  thrift_spec = (
    ...
    (3, TType.LIST, 'addresses', (TType.STRING,None), None, ), # 3
  )

  def __init__(self, network=None, group=None, addresses=None,):
    self.network = network
    self.group = group
    self.addresses = addresses
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i249 in xrange(_size245):
            ...
            self.addresses.append(_elem250)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('watchAddresses_args')
    if self.network is not None:
      oprot.writeFieldBegin('network', TType.I32, 1)
      oprot.writeI32(self.network)
      oprot.writeFieldEnd()
    if self.group is not None:
      ...
      oprot.writeFieldEnd()
    if self.addresses is not None:
      oprot.writeFieldBegin('addresses', TType.LIST, 3)
      oprot.writeListBegin(TType.STRING, len(self.addresses))
      for iter251 in self.addresses:
...
class watchAddresses_result:
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('watchAddresses_result')
    oprot.writeFieldStop()
    oprot.writeStructEnd()
...
class getWatchingList_args:
  ...
  thrift_spec = (
    ...
    (2, TType.STRING, 'group', None, None, ), # 2
    (3, TType.I32, 'count', None, None, ), # 3
    (4, TType.STRING, 'cursor', None, None, ), # 4
  )

  def __init__(self, network=None, group=None, count=None, cursor=None,):
    self.network = network
    self.group = group
    self.count = count
    self.cursor = cursor
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('getWatchingList_args')
    if self.network is not None:
      oprot.writeFieldBegin('network', TType.I32, 1)
      oprot.writeI32(self.network)
      oprot.writeFieldEnd()
...
class getWatchingList_result:
  ...
  thrift_spec = (
    (0, TType.STRUCT, 'success', (TxIdListWithCursor, TxIdListWithCursor.thrift_spec), None, ), # 0
  )
  ...
  def read(self, iprot):
    ...
    while True:
      ...
      if fid == 0:
        if ftype == TType.STRUCT:
          self.success = TxIdListWithCursor()
          self.success.read(iprot)
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('getWatchingList_result')
    if self.success is not None:
      oprot.writeFieldBegin('success', TType.STRUCT, 0)
      self.success.write(oprot)
      oprot.writeFieldEnd()
...
class getWatchingAddressList_args:
  """
  Attributes:
   - network
   - group
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('getWatchingAddressList_args')
    if self.network is not None:
      oprot.writeFieldBegin('network', TType.I32, 1)
      oprot.writeI32(self.network)
      oprot.writeFieldEnd()
...
class getWatchingAddressList_result:
  """
  Attributes:
   - success
  """
  ...
  thrift_spec = (
    (0, TType.STRUCT, 'success', (AddressListWithCursor, AddressListWithCursor.thrift_spec), None, ), # 0
  )
  ...
  def read(self, iprot):
    ...
    while True:
      ...
      if fid == 0:
        if ftype == TType.STRUCT:
          self.success = AddressListWithCursor()
          self.success.read(iprot)
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('getWatchingAddressList_result')
    if self.success is not None:
      oprot.writeFieldBegin('success', TType.STRUCT, 0)
      self.success.write(oprot)
      oprot.writeFieldEnd()
