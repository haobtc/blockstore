...
blockstore.Block.prototype.write = function(output) {
  ...
  if (this.blockHash !== null && this.blockHash !== undefined) {
    output.writeFieldBegin('blockHash', Thrift.Type.STRING, 1);
  ...
  if (this.prevHash !== null && this.prevHash !== undefined) {
    output.writeFieldBegin('prevHash', Thrift.Type.STRING, 3);
    output.writeString(this.prevHash);
    output.writeFieldEnd();
  }
  if (this.merkleRoot !== null && this.merkleRoot !== undefined) {
    output.writeFieldBegin('merkleRoot', Thrift.Type.STRING, 4);
    output.writeString(this.merkleRoot);
    output.writeFieldEnd();
  }
  if (this.isMain !== null && this.isMain !== undefined) {
    output.writeFieldBegin('isMain', Thrift.Type.BOOL, 5);
    output.writeBool(this.isMain);
    output.writeFieldEnd();
  }
  if (this.nextHash !== null && this.nextHash !== undefined) {
    output.writeFieldBegin('nextHash', Thrift.Type.STRING, 6);
    output.writeString(this.nextHash);
    output.writeFieldEnd();
  }
  if (this.cntTxes !== null && this.cntTxes !== undefined) {
    output.writeFieldBegin('cntTxes', Thrift.Type.I32, 7);
  ...
  if (this.timestamp !== null && this.timestamp !== undefined) {
    output.writeFieldBegin('timestamp', Thrift.Type.I64, 9);
    output.writeI64(this.timestamp);
    output.writeFieldEnd();
  }
  if (this.objId !== null && this.objId !== undefined) {
    output.writeFieldBegin('objId', Thrift.Type.STRING, 10);
...
blockstore.TxInput.prototype.write = function(output) {
  ...
  if (this.txid !== null && this.txid !== undefined) {
    output.writeFieldBegin('txid', Thrift.Type.STRING, 1);
...
blockstore.Tx.prototype.write = function(output) {
  ...
  if (this.blockIndex !== null && this.blockIndex !== undefined) {
    output.writeFieldBegin('blockIndex', Thrift.Type.STRING, 3);
    output.writeString(this.blockIndex);
    output.writeFieldEnd();
  }
  if (this.objId !== null && this.objId !== undefined) {
    output.writeFieldBegin('objId', Thrift.Type.STRING, 4);
    output.writeString(this.objId);
    output.writeFieldEnd();
  }
  if (this.inputs !== null && this.inputs !== undefined) {
    output.writeFieldBegin('inputs', Thrift.Type.LIST, 5);
  ...
  if (this.outputs !== null && this.outputs !== undefined) {
    output.writeFieldBegin('outputs', Thrift.Type.LIST, 6);
...
blockstore.UTXO.prototype.write = function(output) {
  ...
  if (this.scriptPubKey !== null && this.scriptPubKey !== undefined) {
    ...
    output.writeString(this.scriptPubKey);
    output.writeFieldEnd();
  }
  if (this.timestamp !== null && this.timestamp !== undefined) {
