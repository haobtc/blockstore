...
class Iface:
  ...
  def addBlock(self, network, block):
    """
    Parameters:
     - network
     - block
  ...
  def addTxList(self, network, txes, soft):
    """
    Parameters:
     - network
     - txes
  ...
  def getTxListSince(self, network, objId):
    """
    Parameters:
     - network
     - objId
  ...
  def getLatestTxList(self, network):
    """
    Parameters:
     - network
    """
...
class Client(Iface):
  ...
  def addBlock(self, network, block):
    ...
    Parameters:
     ...
     - block
    """
    self.send_addBlock(network, block)
    self.recv_addBlock()

  def send_addBlock(self, network, block):
  ...
  def verifyTx(self, network, tx):
    ...
    Parameters:
     ...
     - tx
    """
    self.send_verifyTx(network, tx)
    return self.recv_verifyTx()

  def send_verifyTx(self, network, tx):
  ...
  def addTxList(self, network, txes, soft):
    ...
    Parameters:
     ...
     - soft
    """
    self.send_addTxList(network, txes, soft)
    self.recv_addTxList()

  def send_addTxList(self, network, txes, soft):
  ...
  def getTxListSince(self, network, objId):
    ...
    Parameters:
     ...
     - objId
    """
    self.send_getTxListSince(network, objId)
    return self.recv_getTxListSince()

  def send_getTxListSince(self, network, objId):
  ...
  def getLatestTxList(self, network):
    ...
    Parameters:
     - network
    """
    self.send_getLatestTxList(network)
    return self.recv_getLatestTxList()

  def send_getLatestTxList(self, network):
    self._oprot.writeMessageBegin('getLatestTxList', TMessageType.CALL, self._seqid)
    args = getLatestTxList_args()
    args.network = network
    args.write(self._oprot)
    self._oprot.writeMessageEnd()
    self._oprot.trans.flush()

  def recv_getLatestTxList(self, ):
    (fname, mtype, rseqid) = self._iprot.readMessageBegin()
    if mtype == TMessageType.EXCEPTION:
      x = TApplicationException()
      x.read(self._iprot)
      self._iprot.readMessageEnd()
      raise x
    result = getLatestTxList_result()
    result.read(self._iprot)
    self._iprot.readMessageEnd()
    if result.success is not None:
      return result.success
    raise TApplicationException(TApplicationException.MISSING_RESULT, "getLatestTxList failed: unknown result");
...
class Processor(Iface, TProcessor):
  def __init__(self, handler):
    ...
    self._processMap["getLatestTxList"] = Processor.process_getLatestTxList
  ...
  def process_addBlock(self, seqid, iprot, oprot):
    ...
    result = addBlock_result()
    try:
      self._handler.addBlock(args.network, args.block)
    except AppException as e:
      result.e = e
  ...
  def process_verifyTx(self, seqid, iprot, oprot):
    ...
    iprot.readMessageEnd()
    result = verifyTx_result()
    result.success = self._handler.verifyTx(args.network, args.tx)
  ...
  def process_addTxList(self, seqid, iprot, oprot):
    ...
    iprot.readMessageEnd()
    result = addTxList_result()
    self._handler.addTxList(args.network, args.txes, args.soft)
  ...
  def process_getTxListSince(self, seqid, iprot, oprot):
    ...
    iprot.readMessageEnd()
    result = getTxListSince_result()
    result.success = self._handler.getTxListSince(args.network, args.objId)
    oprot.writeMessageBegin("getTxListSince", TMessageType.REPLY, seqid)
    result.write(oprot)
    oprot.writeMessageEnd()
    oprot.trans.flush()

  def process_getLatestTxList(self, seqid, iprot, oprot):
    args = getLatestTxList_args()
    args.read(iprot)
    iprot.readMessageEnd()
    result = getLatestTxList_result()
    result.success = self._handler.getLatestTxList(args.network)
    oprot.writeMessageBegin("getLatestTxList", TMessageType.REPLY, seqid)
    result.write(oprot)
    oprot.writeMessageEnd()
    oprot.trans.flush()
...
class verifyTx_args:
  ...
  def __init__(self, network=None, tx=None,):
    self.network = network
    self.tx = tx
...
class addTxList_args:
  ...
  thrift_spec = (
    ...
    (3, TType.BOOL, 'soft', None, True, ), # 3
  )

  def __init__(self, network=None, txes=None, soft=thrift_spec[3][4],):
    self.network = network
    self.txes = txes
    self.soft = soft
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i46 in xrange(_size42):
            _elem47 = Tx()
            _elem47.read(iprot)
            self.txes.append(_elem47)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 3:
        if ftype == TType.BOOL:
          self.soft = iprot.readBool();
        else:
          iprot.skip(ftype)
      else:
        iprot.skip(ftype)
  ...
  def write(self, oprot):
    ...
    if self.txes is not None:
      ...
      for iter48 in self.txes:
        iter48.write(oprot)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    if self.soft is not None:
      oprot.writeFieldBegin('soft', TType.BOOL, 3)
      oprot.writeBool(self.soft)
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
    oprot.writeStructEnd()
...
class getTxListSince_args:
  ...
  def __init__(self, network=None, objId=None,):
    self.network = network
    self.objId = objId
...
class getLatestTxList_args:
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('getLatestTxList_args')
    if self.network is not None:
      oprot.writeFieldBegin('network', TType.I32, 1)
      oprot.writeI32(self.network)
      oprot.writeFieldEnd()
...
class getLatestTxList_result:
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('getLatestTxList_result')
    if self.success is not None:
      oprot.writeFieldBegin('success', TType.LIST, 0)
      oprot.writeListBegin(TType.STRUCT, len(self.success))
